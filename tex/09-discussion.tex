\section{Discussion}
  ...
  \paragraph{Connection to the Admissibility Programme.}
    ...
    $\chi_\rho(s) = 0$ encodes compatibility with the bounded-flux constraint $\|c_\chi\| \le 1$
    (Steps~1--2).
  ...
  \paragraph{Scale stability of the classification.}
    ...
    bound $A_n \leq c_\chi/\sqrt{\lambda_n}$, which defines the neutrality window in terms of the
    primitive scale $c_\chi$.
